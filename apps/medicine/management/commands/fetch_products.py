...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        response = requests.post(base_url, auth=auth, headers=headers, json=categories_data, timeout=10)
        ...
        response = requests.post(base_url, auth=auth, headers=headers, json=products_data, timeout=10)
